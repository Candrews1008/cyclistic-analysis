...
p = Path("../data/clean/trips_clean.parquet")
...
avg_str, med_str = f"{avg_min:.2f}", f"{med_min:.2f}"
```
Total rides: `{python} total_rides`   Avg duration (min): `{python} avg_str`   Median duration (min): `{python} med_str`
